...
/**
 * 封装了一些采用Gson操作Json的方法
 * 
 * @see 本工具所采用的是最新的gson-2.2.4
 * @author sunweiwei
 * @version v1.0
 */
public class JsonUtil_1 {

    private static final Logger logger = LoggerFactory.getLogger(JsonUtil_1.class);
     ...
     */
    public static String toJson(Object target, Type targetType, boolean isSerializeNulls, Double version, String datePattern, boolean excludesFieldsWithoutExpose, boolean isGeneralObject) {
        if (target == null) {
        	if (isGeneralObject) {
        		return EMPTY_JSON;
            } else {
    ...
    public static String toJson(Object target) {
        return toJson(target, null, false, null, null, EXCLUDE_FIELDS_WITHOUT_EXPOSE, true);
    }
    ...
    public static String toJson(Object target, String datePattern) {
        return toJson(target, null, false, null, datePattern, EXCLUDE_FIELDS_WITHOUT_EXPOSE, true);
    }
    ...
    public static String toJson(Object target, Double version) {
        return toJson(target, null, false, version, null, EXCLUDE_FIELDS_WITHOUT_EXPOSE, true);
    }
    ...
    public static String toJson(Object target, Type targetType) {
        return toJson(target, targetType, false, null, null, EXCLUDE_FIELDS_WITHOUT_EXPOSE, true);
    }
    ...
    public static String toJson(Object target, Type targetType, Double version) {
        return toJson(target, targetType, false, version, null, EXCLUDE_FIELDS_WITHOUT_EXPOSE, true);
    }
    ...
    public static <T> T fromJson(String json, Type type) {
    	...
    	try {
            ...
            logger.error(json + " 无法转换为 " + type + " 对象!", ex);
            return null;
        }
    }
    /**
